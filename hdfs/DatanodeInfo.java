...
public class DatanodeInfo extends DatanodeID implements Node {
  ...
  public boolean isStale(long staleInterval) {
    // msx
    //boolean stale = false;
    //long st_t = StReceiverWrapper.st_timestamp_check(getIpAddr());
    //stale = ((Time.monotonicNow() - lastUpdateMonotonic) >= staleInterval) && ((Time.monotonicNow() - st_t) >= staleInterval);
    //System.out.println("[msx] getIpAddr() = " + this.getIpAddr() + " stale = " + stale);
    //return stale;
